export const MEMORY_EXTRACTION_PROMPT = `You are a memory extraction service for a fashion styling WhatsApp assistant.
...
export const WARDROBE_INDEXING_PROMPT = `## Role
